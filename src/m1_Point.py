...
class Point(object):
    ...
    def move_to(self, x, y):
        ...
        self.travel = self.travel + distance(self, new_location)
        self.x = x
        self.y = y
    ...
    def move_by(self,  dx, dy):
        ...
        self.y = self.y + dy
        self.moves = self.moves + 1
        self.travel = self.travel + math.sqrt(dx**2 + dy**2)
    ...
    def get_distance_from_start(self):
        initial_point = Point(self.x_start, self.y_start)
        return distance(self, initial_point)

    def get_distance_traveled(self):
        return self.travel

    def closer_to(self, p2, p3):
        distance2 = distance(self, p2)
        distance3 = distance(self, p3)
    ...
    def halfway_to(self, p2):
        x = p2.x + 0.5*(self.x - p2.x)
        y = p2.y + 0.5*(self.y - p2.y)
        return Point(x, y)
...
# I made this function, since I was doing the same thing
# and over again
